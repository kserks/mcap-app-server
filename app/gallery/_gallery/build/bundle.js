var app = (function () {
    ...
    const file$5 = "src\\gallery\\gallery\\components\\Halls.svelte";
    ...
    const file$4 = "src\\gallery\\gallery\\components\\Places.svelte";
    ...
    const file$3 = "src\\gallery\\gallery\\components\\Map.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 18, 6, 486);
    			attr_dev(div1, "class", "image-viewer svelte-s8oyxl");
    			add_location(div1, file$2, 17, 2, 452);
    			attr_dev(span0, "class", "svelte-s8oyxl");
    			add_location(span0, file$2, 22, 6, 595);
    			attr_dev(span1, "class", "svelte-s8oyxl");
    			add_location(span1, file$2, 23, 6, 623);
    			attr_dev(p0, "class", "svelte-s8oyxl");
    			add_location(p0, file$2, 21, 4, 584);
    			attr_dev(span2, "class", "svelte-s8oyxl");
    			add_location(span2, file$2, 26, 6, 676);
    			attr_dev(span3, "class", "svelte-s8oyxl");
    			add_location(span3, file$2, 27, 6, 707);
    			attr_dev(p1, "class", "svelte-s8oyxl");
    			add_location(p1, file$2, 25, 4, 665);
    			attr_dev(span4, "class", "svelte-s8oyxl");
    			add_location(span4, file$2, 30, 6, 758);
    			attr_dev(span5, "class", "svelte-s8oyxl");
    			add_location(span5, file$2, 31, 6, 789);
    			attr_dev(p2, "class", "svelte-s8oyxl");
    			add_location(p2, file$2, 29, 4, 747);
    			attr_dev(div2, "class", "description svelte-s8oyxl");
    			add_location(div2, file$2, 20, 2, 553);
    			attr_dev(div3, "class", "component");
    			add_location(div3, file$2, 16, 0, 425);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\gallery\gallery\components\Exhibitions.svelte generated by Svelte v3.46.3 */

    const file$1 = "src\\gallery\\gallery\\components\\Exhibitions.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(aside0, "class", "left svelte-1pge6xd");
    			add_location(aside0, file, 13, 2, 273);
    			attr_dev(aside1, "class", "center svelte-1pge6xd");
    			add_location(aside1, file, 17, 2, 334);
    			attr_dev(aside2, "class", "right svelte-1pge6xd");
    			add_location(aside2, file, 21, 2, 394);
    			attr_dev(main, "class", "svelte-1pge6xd");
